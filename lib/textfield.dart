...
//         required this.isPasswordColor,
//         required this.showObscureText,
//         this.obscureText = false,
//         // this.keyboard,
//         required this.styleColor,
//         this.hintStyleColor = const Color(0xffbababa),
//         this.enable = true,
//         this.maxLines = 1,
//         this.borderColor = const Color(0xff10151a),
//         this.prefix = AssetImage(''),
//         this.suffix,
//         this.key,
//         this.controller,
