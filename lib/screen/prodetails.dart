...
class ProductDetailScreen extends StatefulWidget {
  ProductDetailScreen({@required this.image,@required this.name,@required this.product,@required this.price, this.description,});

  final String image, name,price,product, description;
  @override
