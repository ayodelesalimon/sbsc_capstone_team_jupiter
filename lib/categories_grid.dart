...
//                                                               color: Color(0xff10151a), fontSize: 17,
//                                                               fontWeight:changeFont? FontWeight.bold : FontWeight.normal),),
//                                                         ),
//                                                         Image.asset('assets/images/mark.png',width: 12,height:12,color: showCheck? Color(0xff3A953C): Colors.transparent),
//                                                       ],
//                                                     ),
//                                                     SizedBox(height: 18,),
...
//
//                                                           },
//                                                           child: Text('Newest Arrival',style: TextStyle(
//                                                               color: Color(0xff10151a), fontSize: 17,
//                                                               fontWeight:changeFont? FontWeight.bold : FontWeight.normal),),
//                                                         ),
//                                                         Image.asset('assets/images/mark.png',width: 12,height:12,
//                                                          color:   showCheck? Color(0xff3A953C): Colors.transparent),
//                                                       ],
//                                                     ),
//                                                     SizedBox(height: 16,),
//                                                     Divider(thickness: 1,color: Color(0xfff5f5f5),),
...
//                                                             // });
//                                                           },
//                                                           child: Text('Prices: Lowest to Highest',style: TextStyle(
//                                                               color: Color(0xff10151a), fontSize: 17,fontWeight:changeFont? FontWeight.bold : FontWeight.normal),
//                                                         ),),
//                                                         Image.asset('assets/images/mark.png',width: 12,height:12,
//                                                           color:showCheck? Color(0xff3A953C): Colors.transparent,
//                                                         ),],
...
//                                                             // });
//                                                           },
//                                                           child: Text('Prices: Highest to Lowest',style: TextStyle(
//                                                               color: Color(0xff10151a), fontSize: 17,fontWeight:changeFont? FontWeight.bold : FontWeight.normal),),
//                                                         ),
//                                                         Image.asset('assets/images/mark.png',width: 12,height:12,color:showCheck? Color(0xff3A953C): Colors.transparent,),
//                                                       ],
...
//                                                   BuildContext context) =>
//                                                   AlertDialog(
//                                                     insetPadding: EdgeInsets.only(top: 285,),
//                                                     content: Center(
//                                                       child:SingleChildScrollView(
//                                                         child: Container(
//                                                           width: 327,
...
//                                                                                   ),
//                                                                                   SizedBox(width: 10,),
//                                                                                   Text('Granular Fruits',style: TextStyle(
//                                                                                     color:Color(0xff10151a),
//                                                                                     fontSize: 17,
//                                                                                   ),),
//                                                                                 ],
...
//                                                                                   ),
//                                                                                   SizedBox(width: 10,),
//                                                                                   Text('Meats & Fish',style: TextStyle(
//                                                                                     color:Color(0xff10151a),
//                                                                                     fontSize: 17,
//                                                                                   ),),
//                                                                                 ],
...
//                                                                                   ),
//                                                                                   SizedBox(width: 10,),
//                                                                                   Text('Organic Food',style: TextStyle(
//                                                                                     color:Color(0xff10151a),
//                                                                                     fontSize: 17,
//                                                                                   ),),
//                                                                                 ],
...
//                                                                    setState(() {
//                                                                      values = value;
//                                                                      // labels = l(value.start.toInt().toString(),value.end.toInt().toString(),);
//                                                                    });
//                                                                   },
//                                                                   activeColor: Color(0xff3A953C),
...
//                                                                           child:TextFormField(
//                                                                             controller: minPrice,
//                                                                               onChanged: (value) => minPrice = value as TextEditingController,
...
//                                                                         ),
//                                                                         ),
//                                                                       Image.asset('assets/images/minus.png',width: 8,color: Color(0xff999999),),
//                                                                       Expanded(
//                                                                         child: Container(
//                                                                           height: 47,
//                                                                           width: 152,
...
//                 //     crossAxisCount: 2,crossAxisSpacing: 16,mainAxisSpacing: 24),
//                 //       itemCount: imageList.length,
//                 //       itemBuilder: (BuildContext context, index){
//                 //        return singleCard(imageList[index], vendorList[index], priceList[index], productList[index],
//                 //            stockList[index], showProdDetails(context, imageList[index], priceList[index],
//                 //                vendorList[index], productList[index]));
//                 //       },
//                 //   )
//                 // ),
//                 Expanded(
...
//
// singleCard(
//     image, vendor,price, product, availability, details
//     ){
//   return Container(
//     child: Column(
//       crossAxisAlignment: CrossAxisAlignment.start,
